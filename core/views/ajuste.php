...
<body>
    ...
    ?>
        ...
        <form action="?a=change" style="position: relative; right: 23%; top:30%" method="post">
            ...
            <!-- ==================SLIDER================= -->
            <div class="container">
                <input type="range" id="my-slider" name="my-slider" min="0" max="1000" value="10" oninput="slider()">
            ...
            <div style="position: absolute; left:44%; top: 155px">
                <!-- ==================BOTAO1================= -->
                <button style="margin-right: 50px;" type="submit" id="a1" name="a1" value="+" class="learn-more">
                ...
                <!-- ==================BOTAO2================= -->
                <button style="margin-left: 40px;" type="submit" id="a2" name="a2" value="-" class="learn-more">
                    <span class="circle" aria-hidden="true">
                        <span class="icon arrow"></span>
                    </span>
        ...
        <script>
            ...
            function slider() {
                ...
                document.getElementById("opt1")
                    ...
                    document.getElementById("htmlvariable").innerHTML = "Subtrair " + mySlider.value + " Euros <br> ";
                    document.getElementById("htmlvariable2").innerHTML = "Adicionar " + mySlider.value + " Euros <br>";
